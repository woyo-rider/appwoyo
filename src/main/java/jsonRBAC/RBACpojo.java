...
public class RBACpojo {
    ...
    public RBACpojo withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RBACpojo withRole(String role) {
        this.role = role;
        return this;
    }
    ...
    public RBACpojo withPermissions(List<Permission> permissions) {
        this.permissions = permissions;
        return this;
    }
    ...
    public RBACpojo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(RBACpojo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RBACpojo) == false) {
            return false;
        }
        RBACpojo rhs = ((RBACpojo) other);
