package com.springbootvaadin.application.data.generator;

import com.springbootvaadin.application.data.entity.SamplePerson;
import com.springbootvaadin.application.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(//PasswordEncoder passwordEncoder,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 7, 18, 0, 0, 0));
            ...
            samplePersonRepositoryGenerator.setData(SamplePerson::setDriverLicence, DataType.PHONE_NUMBER);
