package com.springbootvaadin.application.views.signup;
...
public class SignupView extends Div {
    ...
    private TextField driverLicence = new TextField("Driver Licence");
    ...
    private Component createFormLayout() {
        ...
        formLayout.add(firstName, lastName, phone, driverLicence, email, dateOfBirth,  occupation);
        return formLayout;
    }
