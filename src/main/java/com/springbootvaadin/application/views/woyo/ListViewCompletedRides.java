...
@Route(value = "completedRides", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@CssImport("./styles/views/list-view.css")
public class ListViewCompletedRides extends Div {
...
//        filterRow.getCell(Drop_LongitudeColumn).setComponent(Drop_LongitudeFilter);
    ...
    private List<OngoingRide> getClients() {
        RideDetails usr=getRideDetails("2");
