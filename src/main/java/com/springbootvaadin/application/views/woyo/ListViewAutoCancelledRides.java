...
@PageTitle("Auto Cancelled")
@Route(value = "autoCancelledRides", layout = MainLayout.class)
@RolesAllowed("ADMIN")
@CssImport("./styles/views/list-view.css")
public class ListViewAutoCancelledRides extends Div {
...
//    ListDataProvider<ListSeries>
    ...
    public ListViewAutoCancelledRides() {
